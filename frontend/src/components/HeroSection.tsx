    ...
    <div className="flex-1 px-6 pt-20 pb-6 flex items-end">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start justify-start h-full p-12 pt-36">
          ...
          >
            AI-governed rotating savings built on Celo. Deposit USDm, USDC, or USDT — every payout is validated by multi-agent AI and enforced by smart contracts.
          </p>

          {/* CTA button */}
          <button className="inline-flex items-center gap-3 bg-[#86EFAC] text-black text-base md:text-lg font-medium pl-8 pr-2 py-2 rounded-full hover:bg-[#4ADE80] transition-colors duration-200">
            Start a Group
            <span className="bg-black rounded-full p-2">
              <ArrowRight className="w-5 h-5 text-[#86EFAC]" />
            </span>
          </button>
